...
let MapPage = class MapPage {
    ...
    initMap() {
        let map = this.googleMaps.create(this.element.nativeElement);
        map.one(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsEvent"].MAP_READY).then((data) => {
            let coordinates = new _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["LatLng"](33.6396965, -84.4304574);
            let position = {
                target: coordinates,
                zoom: 17
            };
